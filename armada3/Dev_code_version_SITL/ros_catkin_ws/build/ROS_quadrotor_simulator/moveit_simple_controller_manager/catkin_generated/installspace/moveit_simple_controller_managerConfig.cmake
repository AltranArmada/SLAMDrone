...
if("FALSE" STREQUAL "TRUE")
  set(moveit_simple_controller_manager_SOURCE_PREFIX /home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/src/ROS_quadrotor_simulator/moveit_simple_controller_manager)
  set(moveit_simple_controller_manager_DEVEL_PREFIX /home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/devel)
  ...
  set(moveit_simple_controller_manager_INSTALL_PREFIX /home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_simple_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/install/${idir}'.  Ask the maintainer 'Michael Ferguson <fergs@unboundedrobotics.com>' to fix it.")
    endif()
