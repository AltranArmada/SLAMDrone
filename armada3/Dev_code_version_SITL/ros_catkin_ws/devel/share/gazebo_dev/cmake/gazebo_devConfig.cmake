...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_dev_SOURCE_PREFIX /home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/src/gazebo_ros_pkgs/gazebo_dev)
  set(gazebo_dev_DEVEL_PREFIX /home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/devel)
  ...
  set(gazebo_dev_INSTALL_PREFIX /home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/src/gazebo_ros_pkgs/gazebo_dev/${idir}'.  Ask the maintainer 'John Hsu <hsu@osrfoundation.org>, Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${gazebo_dev_dep}_FOUND)
      find_package(${gazebo_dev_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gazebo_dev_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "/home/user/armada3/Dev_code_version_SITL/ros_catkin_ws/src/gazebo_ros_pkgs/gazebo_dev/cmake/gazebo_dev-extras.cmake")
