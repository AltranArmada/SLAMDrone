...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4f3dB.pack(_x.diffuse.r, _x.diffuse.g, _x.diffuse.b, _x.diffuse.a, _x.attenuation_constant, _x.attenuation_linear, _x.attenuation_quadratic, _x.success))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.diffuse.r, _x.diffuse.g, _x.diffuse.b, _x.diffuse.a, _x.attenuation_constant, _x.attenuation_linear, _x.attenuation_quadratic, _x.success,) = _struct_4f3dB.unpack(str[start:end])
