...
"""
    ...
    try:
      ...
      for val1 in self.trajectories:
        ...
        for val2 in val1.trajectory:
          ...
          buff.write(_struct_2i.pack(_x.secs, _x.nsecs))
      _x = self
      buff.write(_struct_H3I.pack(_x.selected_trajectory_idx, _x.obstacles_msg.header.seq, _x.obstacles_msg.header.stamp.secs, _x.obstacles_msg.header.stamp.nsecs))
      ...
      for val1 in self.obstacles_msg.obstacles:
        ...
        _x = val1
        buff.write(_struct_dq.pack(_x.radius, _x.id))
        ...
        _x = _v20
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        buff.write(_struct_36d.pack(*_v17.covariance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.selected_trajectory_idx, _x.obstacles_msg.header.seq, _x.obstacles_msg.header.stamp.secs, _x.obstacles_msg.header.stamp.nsecs,) = _struct_H3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      for i in range(0, length):
        ...
        (_x.radius, _x.id,) = _struct_dq.unpack(str[start:end])
